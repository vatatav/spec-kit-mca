...
- Modified principles:
   - Development Workflow & Quality Gates: "Tests/design first where applicable" -> "Tests-first (TDD) MUST precede implementation"
   - Communication and Change Discipline: add Character Hygiene rule (ASCII hyphen, no NBSP/ZWSP, UTF-8, script enforcement)
- Added sections:
   - Core Principles -> 9) Tests First (TDD)
- Removed sections: none
- Templates requiring updates:
  - ✅ .specify/templates/plan-template.md (updated to TDD MUST, v1.1.0 reference)
  - ✅ .specify/templates/spec-template.md (updated to TDD MUST, v1.1.0 reference)
  - ✅ .specify/templates/tasks-template.md (updated to TDD MUST, v1.1.0 reference)
  - ✅ .codex/prompts/codex_user_prompts/constitution_prompt.md (already aligned)
